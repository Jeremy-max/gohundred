...
var countrypicker = function(a) {
    ...
    function s(a) {
        ...
        var S = a;
        I[S[0]] = S[1], t[S[1]] = S[0], O[S[2]] = S[0], i[S[0]] = S[2]
    });
    var A = {
            ...
            getName: function(a, S) {
                try {
                    return e[S.toLowerCase()][s(a)]
                } catch (a) {
                    return
                }
            },
            getNames: function(a) {
                var S = e[a.toLowerCase()];
                return void 0 === S ? {} : S
            },
            getAlpha2Code: function(a, S) {
                try {
                    var n, I = e[S.toLowerCase()];
                    for (n in I)
                        if (I.hasOwnProperty(n) && I[n].toLowerCase() === a.toLowerCase()) return n;
                    return
                } catch (a) {
                    return
                }
            ...
            isValid: function(a) {
                return t.hasOwnProperty(a) || I.hasOwnProperty(a) || O.hasOwnProperty(a)
            }
        },
        C = {
            locale: "en",
    ...
    A.registerLocale(C);
    var G = A.getNames("en"),
        c = Object.keys(G).map(function(a) {
            return {
                name: G[a],
                code: a
            }
        ...
        T = function(S) {
            a(this).each(function(S, n) {
                var e = a(n),
                    ...
                    t = c,
                    O = e.data("countries");
                O && O.length && (O = O.toUpperCase().split(","), t = t.filter(function(a) {
                    return O.includes(a.code)
                }));
                var i = [];
                I ? (a.each(t, function(a, S) {
                    i.push('<option\n\t\t\t\t\t\tdata-tokens="' + S.code + '"\n\t\t\t\t\t\tclass="option-with-flag"\n\t\t\t\t\t\tvalue="' + S.code + '">' + S.name + "</option>")
                }), e.on("loaded.bs.select", function(S) {
                    a("a.option-with-flag").each(function() {
                        var S = a(this);
                        if (S.children(".inline-flag").length <= 0) {
                            var n = S.data("tokens").toLowerCase(),
                                e = a('<span class="inline-flag flag ' + n + '"></span>');
                            S.prepend(e)
                        }
                    })
                }), e.on("loaded.bs.select change", function(S) {
                    var n = [];
                    a(this).find(":selected").each(function() {
                        n.push(a(this).data("tokens").toLowerCase())
                    });
                    var e = a(this).parent().find(".btn .filter-option.pull-left");
                    e.removeClass().addClass("filter-option pull-left"), 1 === n.length && n.forEach(function(a) {
                        e.addClass("flag " + a)
                    })
                })) : a.each(t, function(a, S) {
                    i.push('<option\n\t\t\t\t\tdata-countrycode="' + S.code + '\n\t\t\t\t\tdata-tokens="' + S.code + " " + S.name + '"\n\t\t\t\t\tvalue="' + S.code + '">' + S.name + "</option>")
                }), e.addClass("f16").html(i.join("\n"));
                var r = e.data("default");
                r && e.val(r.split(",").map(function(a) {
                    return a.trim()
                }))
            })
        };
    return a.fn.countrypicker = T, a(".countrypicker").countrypicker(), T
}($);
