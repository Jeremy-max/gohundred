...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      ...
      <a href="/">
        <img class = 'logo' src='/assets/media/logos/GoHundred_logo_light.png' style="width:200px;"/>
      </a>
        ...
        <div class="accordion" id="accordionExample">
          ...
          <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
              <div class="card-body">
                You can upgrade your account from the profile tab in the right corner of your dashboard. Click “Upgrade plan” and you will be redirected to the upgrade page.
              </div>
            </div>
          </div>
          <div class="card">
      ...
      <div class="modal-body">
        <div class="accordion" id="Example">
          <div class="card">
            ...
            <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1" data-parent="#Example">
              <div class="card-body">
                <strong>Use GoHundred to:</strong><br>
                  - Research popularity of topics and opinions<br>
                  - Analyze human communication and Social Media patterns
          ...
          <div class="card">
            <div class="card-header" id="headingTwo1">
              <h2 class="mb-0">
                <button class="btn  collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
                  You are a blogger or influencer looking to grow your online presence
                </button>
              </h2>
            </div>
            <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#Example">
              <div class="card-body">
                <strong>Use GoHundred to:</strong><br>
              - Find out who talks about you, your brand <br>
              - Find new competitors in your field<br>
              - Find new companies to influence for
          ...
          <div class="card">
            <div class="card-header" id="headingThree1">
              <h2 class="mb-0">
                <button class="btn  collapsed" type="button" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
                  You are part of a startup team looking to grow and learn about your market
                </button>
              </h2>
            </div>
            <div id="collapseThree1" class="collapse" aria-labelledby="headingThree1" data-parent="#Example">
              <div class="card-body">
                <strong>Use GoHundred to:</strong><br>
                - Find out who talks about your brand and company <br>
                - Find trending topics and opinions<br>
                - Find new competitors in your industry
          ...
          <div class="card">
            <div class="card-header" id="headingFour1">
              <h2 class="mb-0">
                <button class="btn  collapsed" type="button" data-toggle="collapse" data-target="#collapseFour1" aria-expanded="false" aria-controls="collapseFour1">
                  You are part of an enterprise looking to stay ahead in your industry
                </button>
              </h2>
            </div>
            <div id="collapseFour1" class="collapse" aria-labelledby="headingFour1" data-parent="#Example">
              <div class="card-body">
                <strong>Use GoHundred to:</strong><br>
                - Find out who talks about your brand and company <br>
                - Find trending topics and opinions<br>
